...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230602131915_ordersMethods")]
    partial class ordersMethods
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Extend.Address", b =>
                {
                    b.HasOne("Infrastructure.Extend.AppUser", "AppUser")
                        .WithOne("Address")
                        .HasForeignKey("Infrastructure.Extend.Address", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Infrastructure.Extend.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
